...
env.theme_path = '/home/bartek/blog/blog/twenty-pelican-html5up'
# Remote server configuration
production = 'moodypaths@s17.mydevil.net:22'
dest_path = '/home/moodypaths/domains/moodypaths.usermd.net/public_python/public'
...
def collectstatic():
  if os.path.isdir(DEPLOY_PATH):
    ...
    local('cp -rf content/pictures/* {deploy_path}/pictures/'.format(**env))